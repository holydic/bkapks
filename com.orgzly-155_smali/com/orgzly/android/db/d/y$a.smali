.class Lcom/orgzly/android/db/d/y$a;
...
.method public bridge synthetic a(Lg/p/a/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/orgzly/android/db/d/y$a;->a(Lg/p/a/g;Lcom/orgzly/android/db/e/n;)V
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "INSERT OR ABORT INTO `org_timestamps` (`id`,`string`,`is_active`,`year`,`month`,`day`,`hour`,`minute`,`second`,`end_hour`,`end_minute`,`end_second`,`repeater_type`,`repeater_value`,`repeater_unit`,`habit_deadline_value`,`habit_deadline_unit`,`delay_type`,`delay_value`,`delay_unit`,`timestamp`,`end_timestamp`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
