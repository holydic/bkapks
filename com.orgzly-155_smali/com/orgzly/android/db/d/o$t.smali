.class Lcom/orgzly/android/db/d/o$t;
...
.method public a(Lg/p/a/g;Lcom/orgzly/android/db/e/g;)V
    ...
    invoke-interface {p1, v8, v9, v10}, Lg/p/a/d;->bindLong(IJ)V
    ...
    .line 41
    invoke-virtual {v0}, Lcom/orgzly/android/db/e/j;->c()J
    ...
    .line 42
    invoke-virtual {v0}, Lcom/orgzly/android/db/e/j;->h()Z
    ...
    .line 45
    :cond_a
    invoke-interface {p1, v8}, Lg/p/a/d;->bindNull(I)V
...
.method public bridge synthetic a(Lg/p/a/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/orgzly/android/db/d/o$t;->a(Lg/p/a/g;Lcom/orgzly/android/db/e/g;)V
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `notes` SET `id` = ?,`is_cut` = ?,`created_at` = ?,`title` = ?,`tags` = ?,`state` = ?,`priority` = ?,`content` = ?,`content_line_count` = ?,`scheduled_range_id` = ?,`deadline_range_id` = ?,`closed_range_id` = ?,`clock_range_id` = ?,`book_id` = ?,`lft` = ?,`rgt` = ?,`level` = ?,`parent_id` = ?,`folded_under_id` = ?,`is_folded` = ?,`descendants_count` = ? WHERE `id` = ?"
