.class Lcom/orgzly/android/db/d/y$d;
...
.method public bridge synthetic a(Lg/p/a/g;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/orgzly/android/db/d/y$d;->a(Lg/p/a/g;Lcom/orgzly/android/db/e/n;)V
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR ABORT `org_timestamps` SET `id` = ?,`string` = ?,`is_active` = ?,`year` = ?,`month` = ?,`day` = ?,`hour` = ?,`minute` = ?,`second` = ?,`end_hour` = ?,`end_minute` = ?,`end_second` = ?,`repeater_type` = ?,`repeater_value` = ?,`repeater_unit` = ?,`habit_deadline_value` = ?,`habit_deadline_unit` = ?,`delay_type` = ?,`delay_value` = ?,`delay_unit` = ?,`timestamp` = ?,`end_timestamp` = ? WHERE `id` = ?"
